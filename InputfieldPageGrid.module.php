...
class InputfieldPageGrid extends Inputfield {
    ...
    public function ___renderField() {
        ...
        if ($user->hasPermission('pagegrid-style-panel') && $this->ft->stylePanel) {
            ...
            <i class="pg-item-list-button fa fw fa-list-ul on" uk-tooltip="title:Item List; pos:bottom; delay:300;"></i>
            <div id="pg-undo-redo-wrapper"><i class="pg-undo fa fa-fw fa-reply" data-name="fa-reply" uk-tooltip="title:Undo; pos:bottom; delay:300;"></i>
